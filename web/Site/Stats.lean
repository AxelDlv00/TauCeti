  ...
  <div class="loc-graphs">
    ...
    <figure class="loc-figure">
      <img class="loc-graph" src="static/cumulative-reviews-by-contributor.svg"
           ...
           loading="lazy"/>
      <figcaption>"Cumulative canonical v1 review scoreboards posted by contributors who have authored a merged PR; other accounts and edits to existing scoreboards do not add counts."</figcaption>
    </figure>
  </div>
}}
...
the generated [`pr-stats.json`](static/pr-stats.json). Review attribution includes only
canonical v1 scoreboards whose posting login also authors a merged PR in the fetched
snapshot.
